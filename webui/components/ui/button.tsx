...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-[#6affb0] text-[#00363a] shadow-none hover:bg-[#52e89a] active:scale-[0.98]",
        outline:
          "glass-control hover:bg-muted/70 hover:text-primary aria-expanded:bg-muted/70 aria-expanded:text-primary",
        secondary:
          "glass-control text-foreground hover:bg-white/10 hover:text-primary aria-expanded:bg-white/10 aria-expanded:text-primary",
        ghost:
          "hover:bg-muted/70 hover:text-primary aria-expanded:bg-muted/70 aria-expanded:text-primary",
        destructive:
