...
METHOD_GROUP: dict[str, str] = {
    ...
    "get_dragon_tiger": "股票基本面",
    "get_margin_trading": "股票基本面",
    "get_shareholders": "股票基本面",
    "get_profit_forecast": "股票基本面",
...
METHOD_DESC: dict[str, str] = {
    ...
    "get_dragon_tiger": "龙虎榜(上榜明细)",
    "get_margin_trading": "融资融券(个股明细)",
    "get_shareholders": "股东户数",
...
METHOD_PROBES: dict[str, Callable[[str, str], tuple]] = {
    ...
    "get_dragon_tiger": lambda c, d: (c, d),
    "get_margin_trading": lambda c, d: (c, d),
    "get_shareholders": lambda c, d: (c, d),
    "get_profit_forecast": lambda c, d: (c, d),
