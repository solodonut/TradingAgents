...
class DataflowsConfigIsolationTests(unittest.TestCase):
    ...
    def test_get_config_returns_deep_copy(self):
        ...
        fresh = get_config()
        self.assertEqual(fresh["data_vendors"]["core_stock_apis"], "amazingdata,tushare,akshare")
    ...
    def test_partial_nested_update_preserves_existing_defaults(self):
        ...
        fresh = get_config()
        self.assertEqual(fresh["data_vendors"]["core_stock_apis"], "alpha_vantage")
        self.assertEqual(fresh["data_vendors"]["technical_indicators"], "amazingdata,tushare,akshare")
        self.assertEqual(fresh["data_vendors"]["fundamental_data"], "amazingdata,tushare,akshare")
        self.assertEqual(fresh["data_vendors"]["news_data"], "akshare,longbridge")
